...
- `PlanEditorRoot` handles unconsumed Escape events for any nonempty selection from list, Inspector and
  ...
  preserves persistent control focus and returns disappearing selection controls to the Inspector.
