...
As of 2026-09-09, PR #95 head `ba57db14` passes every CI leg and the unchanged full check: 8,238 passing tests, 98.04% branches, and static analysis. Photo addition `cc6c90a9`, reference viewport `d2d5d165`, Review alignment `251dc7c3`, saved-group schema 6 `587f0266`, group interactions `f8028295`/`f7e35ef4`, curved-boundary schema 7 and UI `3192c463`/`6dcb8942`/`af7583b0`, opening Move `ab993f00`, and stairs/arrows checkpoint `d4cc09e8` are integrated with their focused verification. Group-member deletion and Stair input/activation follow-ups, the unchanged full combined gate, final native/browser acceptance, and reviewable concern PR publication remain in progress. This task remains open.
