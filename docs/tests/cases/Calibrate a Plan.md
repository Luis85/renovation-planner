...
| 2 | `browser` | Look at the toolbar | A **Calibrate** button sits beside Pan / Select / Draw zone | The registration itself. `CalibrateTool` existed, tested, registered nowhere for a whole slice — no gate can see a tool that is merely absent from a list |
