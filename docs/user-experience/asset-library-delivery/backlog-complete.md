...
Required predecessors: [PBI-01](../../requirements/Open%20and%20resume%20the%20shared%20asset%20library.md). Necessary application collaborators have been checked against the target commit; fixtures include the normal and failure conditions described here. The trigger is the user action in the main flow.
...
Required predecessors: [PBI-02](../../requirements/Compare%20and%20select%20assets%20within%20category%20groups.md). Necessary application collaborators have been checked against the target commit; fixtures include the normal and failure conditions described here. The trigger is the user action in the main flow.
...
Required predecessors: [PBI-04](../../requirements/Inspect%20the%20complete%20definition%20of%20a%20selected%20asset.md), [EN-02](enablers/EN-02.md). Necessary application collaborators have been checked against the target commit; fixtures include the normal and failure conditions described here. The trigger is the user action in the main flow.
...
Required predecessors: [PBI-05](../../requirements/Explicitly%20save%20or%20discard%20asset%20metadata%20changes.md). Necessary application collaborators have been checked against the target commit; fixtures include the normal and failure conditions described here. The trigger is the user action in the main flow.
...
Required predecessors: [PBI-05](../../requirements/Explicitly%20save%20or%20discard%20asset%20metadata%20changes.md), [PBI-10](../../requirements/Understand%20project%20usage%20and%20each%20project's%20price%20source.md). Necessary application collaborators have been checked against the target commit; fixtures include the normal and failure conditions described here. The trigger is the user action in the main flow.
...
Required predecessors: [PBI-01](../../requirements/Open%20and%20resume%20the%20shared%20asset%20library.md), [PBI-06](../../requirements/Switch%20assets%20without%20accidentally%20losing%20input.md). Necessary application collaborators have been checked against the target commit; fixtures include the normal and failure conditions described here. The trigger is the user action in the main flow.
...
Required predecessors: [PBI-04](../../requirements/Inspect%20the%20complete%20definition%20of%20a%20selected%20asset.md). Necessary application collaborators have been checked against the target commit; fixtures include the normal and failure conditions described here. The trigger is the user action in the main flow.
...
Required predecessors: [PBI-06](../../requirements/Switch%20assets%20without%20accidentally%20losing%20input.md), [PBI-10](../../requirements/Understand%20project%20usage%20and%20each%20project's%20price%20source.md). Necessary application collaborators have been checked against the target commit; fixtures include the normal and failure conditions described here. The trigger is the user action in the main flow.
...
Required predecessors: [PBI-06](../../requirements/Switch%20assets%20without%20accidentally%20losing%20input.md). Necessary application collaborators have been checked against the target commit; fixtures include the normal and failure conditions described here. The trigger is the user action in the main flow.
...
Required predecessors: [PBI-05](../../requirements/Explicitly%20save%20or%20discard%20asset%20metadata%20changes.md), [PBI-13](../../requirements/Keep%20valid%20content%20after%20loading%20failures%20and%20retry%20the%20affected%20read.md). Necessary application collaborators have been checked against the target commit; fixtures include the normal and failure conditions described here. The trigger is the user action in the main flow.
...
Required predecessors: [PBI-03](../../requirements/Find%20an%20asset%20by%20name,%20supplier,%20or%20SKU.md), [PBI-06](../../requirements/Switch%20assets%20without%20accidentally%20losing%20input.md). Necessary application collaborators have been checked against the target commit; fixtures include the normal and failure conditions described here. The trigger is the user action in the main flow.
...
Required predecessors: [PBI-09](../../requirements/Create%20a%20new%20asset%20without%20an%20existing%20project.md), [PBI-15](../../requirements/Use%20the%20library%20in%20narrow%20panels%20and%20host%20themes.md). Necessary application collaborators have been checked against the target commit; fixtures include the normal and failure conditions described here. The trigger is the user action in the main flow.
...
Required predecessors: [PBI-10](../../requirements/Understand%20project%20usage%20and%20each%20project's%20price%20source.md), [PBI-14](../../requirements/Continue%20safely%20after%20save%20failures%20or%20external%20changes.md). Necessary application collaborators have been checked against the target commit; fixtures include the normal and failure conditions described here. The trigger is the user action in the main flow.
...
Required predecessors: [EN-01](enablers/EN-01.md), [PBI-11](../../requirements/Navigate%20from%20an%20asset%20to%20its%20note%20or%20a%20project%20using%20it.md). Necessary application collaborators have been checked against the target commit; fixtures include the normal and failure conditions described here. The trigger is the user action in the main flow.
