...
**Historical exploration, 2026-09-13. Superseded by the user's combination of directions 1 and 3; see the [selected hybrid](README.md). Pending-selection statements below describe the earlier review state. No implementation.**
