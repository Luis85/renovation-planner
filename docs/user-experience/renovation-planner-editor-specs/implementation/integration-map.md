...
- Downstream dialog focus: `89f498f9cac68e0265f4d39ceab90fd1401e2ab9` → `0d115e38`, from the existing recovery task on `codex/downstream-dialog-focus`, based on c1091086. Native Edit/Revise/Work dialogs return focus to the persistent Project Back control only when refresh removed their opener and focus otherwise fell to the document body. Owner RED reproduced four defects; GREEN passed 20 tests. Root saved-source changes preserve those exact dialog blocks; joined verification is in progress.


- Reference reflow recovery: 008529478534b6b0aa300c69d722bd4ace948936 → 66438ff3, from the existing recovery task on codex/reference-focus-recovery based on 9e2b89f8. The shared focus helper captures Layers/Inspector origin and returns to a visible rail after reflow. Six native cases reproduced four failures before correction and passed afterward; the broader owner run passed 46 tests. The final equivalent inline type spelling passes joined vue-tsc, whole Oxlint and scoped ESLint. See [Reference focus evidence](reference-focus-recovery-evidence.md).
- Final connected capture corrections: UI 67cffc8491e574545a1fb02b7f95ea002d0bd42c → 803039ae, 7fce5a7414ced79d3d6c47cfbe00cce645dfffe1 → b3ac518d and b5c57a68caa762ca5949ad8d291283c69b5da1be → 28e01595. Work/Costs captures use native downstream navigation with actual spending facts; planning/renovation design runs use the representative floor and wait for loaded photo thumbnails. Original journey assertions and ordinary defaults remain. Syntax checks pass; the final matrix has not yet rerun.

- Root downstream correction: 80437fa0. Canonical quote/Room invalidation, editable read-paused element drafts, Project Work conflict refresh and inert history controls, native header/form reflow, component simplification, exact openPlan origins and actual note/service contracts. The two new plugin-composition tests use the existing explicit browser environment; gates are unchanged.
- UI downstream and detail options: 49ed14761bb28a19fabfd73a5978891b96ddb826 → e4222ffe; 83d7af0cf20a873dd61af384f9e76b9f8c0f932e → a7319ca1; 9009c3136db8268b43719e2b6d4d6bbe8ca705f7 → 2d23b73a. The single-root ninth journey, stateless canvas detail options and inclusion of downstream captures in the final image inventory are integrated. Owner four-scenario/sixteen-axe evidence precedes the corrected German headers/forms and is not final visual acceptance.
- Hardening lifecycle/guards: a2c75f473af87f24c1aaad866390d7578faaacd5 → 25b4365c. Four native element lifecycle cases, fifteen actual composed guard cases and the synchronous successful structure baseline helper are integrated. Owner 46/46 cases, types, whole Oxlint/scoped ESLint and zero clone groups pass. No owner full coverage or health pass is claimed.

The latest committed production correction is 0d115e38. Root saved-source and Retry-focus recovery is being verified before its checkpoint; final browser evidence remains pending.
