...
| Improve M15 recovery workflow | codex/planning-recovery | `66bcd0d033753796e4c290c88f9bbb05322a30db` (#90), via `aecef294` and `816b7929` | Preserve retained drafts, coalesced read-back, conflict/history gates and locale parsing; finalization owns contextual draft defaults |
