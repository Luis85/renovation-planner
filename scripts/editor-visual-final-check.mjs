...
const commands = [
	...
	['editor-visual-resilience.mjs'], ['editor-visual-overview.mjs'],
...
for (const directory of ['materials-costs-evidence', 'renovation-workflow', 'reference-plan', 'editor-visual-resilience', 'editor-visual-overview']) {
