 ...
 * index it read — while `npm run harness-shot prototype:ZoneSummary` would write the eighteen
 ...
 * quoted empty string would otherwise run the eighteen fixed shots and exit 0 rather than
