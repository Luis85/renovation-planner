...
const SHOTS = [
	...
	// that proves it — `&view-menu` opens it through the real summary click. `.rp-view-menu__content` is a
	// child of the `<details>` and is attached to the DOM whether or not it is open, so waiting on it alone
