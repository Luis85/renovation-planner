...
export class GetRequirementsForZone
	implements
			Query<ZoneId, Result<RequirementInspectorDTO[], PersistenceError>>
{
	constructor(
	...
	async execute(zoneId: ZoneId): Promise<Result<RequirementInspectorDTO[], PersistenceError>> {
	...
	private async buildRow(
		r: Requirement,
	): Promise<Result<RequirementInspectorDTO, PersistenceError>> {
