...
export class GetZoneInspector
	implements Query<GetZoneInspectorInput, Result<ZoneInspectorFields | null, RepositoryError | GeometryError>>
{
	constructor(private readonly zones: ZoneRepository) {}

	async execute({ zoneId }: GetZoneInspectorInput): Promise<Result<ZoneInspectorFields | null, RepositoryError | GeometryError>> {
