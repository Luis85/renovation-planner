...
export const QUANTITY_RULES = ['room-area', 'room-perimeter', 'wall-gross', 'wall-net', 'wall-length', 'opening-area', 'count', 'manual'] as const;
...
function measurement(source: RequirementSource, roomId: string, geometry: QuantityGeometry): Measurement | null {
 ...
 return wallMeasurement(source, structure) ?? roomMeasurement(source, roomId, geometry);
}
