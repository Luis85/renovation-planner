...
import { SpatialObjectGeometrySchemaV16, type SpatialObjectGeometryDTO } from '../../persistence/dto/planGeometry';
 ...
 */
const ENTRY_KEYS = [...Object.keys(SpatialObjectGeometrySchemaV16.shape), 'dx', 'dy'];
