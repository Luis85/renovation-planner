...
import { SpatialObjectGeometrySchemaV15, type SpatialObjectGeometryDTO } from '../../persistence/dto/planGeometry';
 ...
 */
const ENTRY_KEYS = [...Object.keys(SpatialObjectGeometrySchemaV15.shape), 'dx', 'dy'];
