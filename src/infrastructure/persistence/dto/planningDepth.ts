import { isCalendarDate } from '../../../domain/schedule/WorkSchedule';
...
export const PlanningDepthSchema = z.object({
	...
	evidence: z.array(z.object({ ...context, links: SharedLinksSchema, description: z.string(), date: z.string().refine(isCalendarDate).optional(), type: z.enum(EVIDENCE_TYPES), phase: z.enum(EVIDENCE_PHASES), path: id, subpath: z.string(), recordId: z.string(),
