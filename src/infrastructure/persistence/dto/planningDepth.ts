...
export const PlanningDepthSchema = z.object({
	...
	evidence: z.array(z.object({ ...context, links: SharedLinksSchema, description: z.string(), type: z.enum(EVIDENCE_TYPES), phase: z.enum(EVIDENCE_PHASES), path: id, subpath: z.string(), recordId: z.string(),
