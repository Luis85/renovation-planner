 ...
 * is what keeps its name inside the same union every layer is checked against.
 */
/**
 ...
 * literal against this union, so a typo there is a build error rather than a silent extra
