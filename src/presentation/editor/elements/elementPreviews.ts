...
export function withElementPreviews(elements: readonly SpatialElement[], names: ReadonlyMap<string, string>, rotation: { readonly id: string; readonly name: string; readonly points: readonly Point[] } | null, moved: NamedSpatialElement | null, label: { readonly id: string; readonly offset: Vector } | null): NamedSpatialElement[] {
