 ...
 * prints nothing at all, while "Abstand" is already this table's word for an offset —
...
export const assetDimensionsOnCanvasDe: Record<keyof typeof assetDimensionsOnCanvasEn, string> = {
	...
	'designer.dimension.unavailable': 'Geben Sie ein Maß in ganzen Millimetern ein.',
