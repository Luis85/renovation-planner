...
export const enAssetLibrary = {
	...
	"view.asset-library.draft.number": "Enter a finite, nonnegative number; waste must be between 0 and 100%.",
	"view.asset-library.draft.conflict": "This note changed since you started editing. Review the current values, then discard to reload. Your draft is preserved.",
	"view.asset-library.draft.refresh": "Asset saved. Refresh needed before editing again. Project recalculation is reported separately.",
	"view.asset-library.draft.unknown": "The write outcome could not be confirmed. Check the current note before discarding this draft or trying again.",
	"view.asset-library.draft.save": "Save",
	"view.asset-library.draft.discard": "Discard",
	"view.asset-library.draft.saving": "Saving…",
	"view.asset-library.draft.saved": "Asset saved",
	"view.asset-library.outside-search": "Selected asset is outside the search results.",
	"view.asset-library.used-in.library-price": "Library price",
	...
	// Housed here rather than in `en.ts` for the same `max-lines` reason as the rest of this
	// file — moved by the CLAUDE.md rule this file's own header cites.
