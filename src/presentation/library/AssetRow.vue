...
import { spokenMark } from './markWords';
...
/** §3.4's words for this row's mark — `markWords.ts`, shared with the grid's tile. */
const spoken = computed((): string => spokenMark(props.outline));
