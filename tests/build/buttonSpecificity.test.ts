 ...
 * earlier ring.
 *
 * The CONTEXT is what the rule is scoped to — everything before the subject. It is NOT part of the
 * key, and the reason is that the two directions want opposite things. A narrowly scoped RESET must
