...
describe('resolveShots', () => {
	 ...
	 * the nine fixed PNGs and exited 0. Driving this function with a real argv array is what
	 ...
	 * to run the nine fixed shots and exit 0 rather than reporting an unnamed entry.
	 */
