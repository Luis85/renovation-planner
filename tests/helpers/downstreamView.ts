...
export async function downstreamView(rig: Awaited<ReturnType<typeof downstreamStack>>, section: 'schedule' | 'quotes') {
 ...
 const context: RenovationProjectDeps = { ...defaultRenovationProjectDeps(), projectId: rig.plan.projectId, section, work, quotes, session: { query: '', completedOpen: false, focusedProjectId: null, scrollTop: 0, guidanceHidden: false } };
