import { TradeFrontmatterSchemaV1, SupplierFrontmatterSchemaV1 } from '../../../../src/infrastructure/persistence/dto/namedCatalogueFrontmatter';
...
import { PLAN_TYPE, PlanFrontmatterSchemaV7 } from '../../../../src/infrastructure/persistence/dto/planFrontmatter';
...
import { REQUIREMENT_TYPE, RequirementFrontmatterSchemaV3 } from '../../../../src/infrastructure/persistence/dto/requirementFrontmatter';
...
describe("a note is digested against its own kind's schema", () => {
	const SCHEMA_BY_TYPE: Readonly<Record<EntityType, { readonly shape: Readonly<Record<string, unknown>> }>> = {
		...
		[PLAN_TYPE]: PlanFrontmatterSchemaV7,
