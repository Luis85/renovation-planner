...
import { SpatialObjectGeometrySchemaV16, type PlanGeometryDTO } from '../../../../src/infrastructure/persistence/dto/planGeometry';
...
it('refuses invalid curved content on read and dangling group membership on write without modifying the sidecar', async () => {
	...
	for (const object of objects) expect(SpatialObjectGeometrySchemaV16.safeParse(object).success).toBe(true);
