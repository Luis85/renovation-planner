...
// Align/Distribute's icon-only rendering (AD18-R16 Task 10) moved to
// `designerArrangeIcons.test.ts` (final-fix-wave, over the 450-line tests/** cap): that describe
// block was self-contained and mounted bare, unlike everything below it here.
